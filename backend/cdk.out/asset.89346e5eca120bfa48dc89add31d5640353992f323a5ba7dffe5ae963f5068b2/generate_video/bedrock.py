...
def _bedrock_client(region_name: str):
    client = _bedrock_clients.get(region_name)
    if client is None:
...
def invoke_anthropic(
    ...
    *,
    ...
    # Anthropic model hosted in us-west-2
    client = _bedrock_client("us-west-2")
...
def generate_image_bytes(
    *,
    ...
    # Nova Canvas model hosted in us-east-1; add a generous read timeout
    client = _bedrock_client("us-east-1")
